...
public class MediorThree {
    ...
    public static void printName(String firstName, String lastName) {
        String formattedFirstName = firstLetterToUpperCase(firstName);
        String formattedLastName = firstLetterToUpperCase(lastName);
        System.out.println("Naam: " + formattedFirstName + " " + formattedLastName);
    }
